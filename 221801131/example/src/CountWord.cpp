...
int CountWord::getcharacternum() {
    return characternum;
}
int CountWord::getlinenum() {
    return linenum;
}
int CountWord::getwordnum1() {
    return wordnum1;
}

int CountWord::getwordnum2() {
    return wordnum2;
}

Words* CountWord::getwords() {
    return wwords;
}

int CountWord::charactersCount(char* Path) {    //计算字符数量
...
int CountWord::wordCount(char* Path) {    //计算单词个数
...
int CountWord::lineCount(char* Path) {    //计算行
...
void CountWord::safeWord(char* str) {
    string word;
    word = str;
